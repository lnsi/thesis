...
The following design decisions address the requirements RA-1 to RA-4.

\begin{enumerate}[{DA}-1]
\item \hfill
	\begin{enumerate}[{DA-1}a]
	\item Pairing is triggered by placing the smartphone on the tabletop, for the reason that it is a simple gesture that is consistent with the form of the tabletop.
...
The following design decisions address the requirements RB-1 to RB-4.
...
The following design decisions address the requirements RC-1 to RC-4.
...
The following design decisions address the requirements RD-1 to RD-6.
