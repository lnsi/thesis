...
\begin{figure}[htb]
  ...
  \caption{People using an interactive tabletop exhibit at the Asia Society Museum. Source: T. Geller. Interactive tabletop exhibits in museums and galleries. Computer Graphics and Applications, 2006.}
  \label{fig:visitors}
\end{figure}
